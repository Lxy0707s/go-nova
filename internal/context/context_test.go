...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/go-nova/")
	ctx2 := context.WithValue(context.Background(), ctxKey2{}, "https://go-nova.dev/")
	...
	if !reflect.DeepEqual(value1, "https://github.com/go-nova/") {
		t.Errorf("expect %v, got %v", "https://github.com/go-nova/", value1)
	}
	...
	if !reflect.DeepEqual("https://go-nova.dev/", value2) {
		t.Errorf("expect %v, got %v", "https://go-nova.dev/", value2)
	}
...
func TestMerge(t *testing.T) {
	...
	cancel()
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/go-nova/")
	ctx2 := context.WithValue(ctx, ctxKey2{}, "https://go-nova.dev/")
	...
	if !reflect.DeepEqual(value2, "https://go-nova.dev/") {
		t.Errorf("expect %v, got %v", " https://go-nova.dev/", value2)
	}
