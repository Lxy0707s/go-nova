...
func TestApp_Endpoint(t *testing.T) {
	v := []string{"https://go-nova.dev", "localhost"}
...
func TestApp_buildInstance(t *testing.T) {
	want := struct {
		...
		endpoints: []string{"https://go-nova.dev", "localhost"},
	}
	var endpoints []*url.URL
	...
	tests := []fields{
		{
			...
			want: struct {
				...
				id: "1", version: "v1", name: "kratos-v1", endpoint: []string{"https://go-nova.dev", "localhost"},
				metadata: map[string]string{},
			},
		},
		{
