...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "UserMutationObject.register":
		if e.complexity.UserMutationObject.Register == nil {
			break
		}

		args, err := ec.field_UserMutationObject_register_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "UserQueryObject.user_list":
		...
		args, err := ec.field_UserQueryObject_user_list_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
type Query {
	...
	{Name: "../../../module/demo/user_graphql/sdl/user.graphql", Input: `
type User {
    id: Int64!
    username: String!
    password: String!
...
func (ec *executionContext) fieldContext_Mutation_User(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "register":
				return ec.fieldContext_UserMutationObject_register(ctx, field)
			}
...
func (ec *executionContext) fieldContext_Query_User(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "user_list":
				return ec.fieldContext_UserQueryObject_user_list(ctx, field)
			}
...
func (ec *executionContext) fieldContext_UserMutationObject_register(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_UserMutationObject_register_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) fieldContext_UserQueryObject_user_list(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_UserQueryObject_user_list_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputNewUser(ctx context.Context, obj interface{}) (model.NewUser, error) {
	...
	fieldsInOrder := [...]string{"username", "address", "email", "phone", "status"}
	...
	for i, field := range fields {
		...
		case "register":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._UserMutationObject_register(ctx, field, obj)
				if res == graphql.Null {
	...
	for i, field := range fields {
		...
		case "user_list":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._UserQueryObject_user_list(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
