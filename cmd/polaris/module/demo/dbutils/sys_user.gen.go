...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.PPassword = field.NewString(tableName, "password")
	_sysUser.PPhone = field.NewString(tableName, "phone")
	_sysUser.PAddress = field.NewString(tableName, "address")
	_sysUser.PEmail = field.NewString(tableName, "email")
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.PPassword = field.NewString(table, "password")
	s.PPhone = field.NewString(table, "phone")
	s.PAddress = field.NewString(table, "address")
	s.PEmail = field.NewString(table, "email")
...
func (s *sysUser) fillFieldMap() {
	...
	s.fieldMap["password"] = s.PPassword
	s.fieldMap["phone"] = s.PPhone
	s.fieldMap["address"] = s.PAddress
	s.fieldMap["email"] = s.PEmail
...
type ISysUserDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.SysUser, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (s sysUserDo) FilterWithNameAndRole(name string, role string) (result []model.SysUser, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM sys_user WHERE name = ? ")
	if role != "" {
